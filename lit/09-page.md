    ...
    <div id="app">
      ...
      <div id="game" class="screen hidden">
        <div class="game-info">
          ...
          <div>Grid: <span id="grid-size">10x10</span></div>
        </div>
        <canvas id="canvas"></canvas>
        <div class="controls">Use Arrow Keys or WASD to move | Press P to Pause | Press Shift+R to Reset | +/- to change grid size | Press any direction to start</div>
      </div>
      <div id="game-over" class="screen hidden">
        <h1>Game Over!</h1>
        <div class="final-score">Score: <span id="final-score">0</span></div>
        <div class="high-score">High Score: <span id="game-over-high-score">0</span></div>
        <button id="play-again">Play Again</button>
      </div>
      <div id="pause" class="screen hidden overlay">
        <h1>Paused</h1>
